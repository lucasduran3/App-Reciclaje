...
export default function Login() {
  ...
  const validateForm = () => {
    ...
    if (!formData.identifier.trim()) {
      newErrors.identifier = 'Usuario o email es requerido';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ 
        general: error.message || 'Credenciales inválidas. Verifica tu usuario y contraseña.' 
      });
    } finally {
      setLoading(false);
    }
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div style={{ position: 'relative' }}>
              <input
                ...
                style={{
                  ...
                  padding: 'var(--spacing-md)',
                  paddingLeft: '3rem',
                  border: `1px solid ${errors.identifier ? 'var(--danger)' : 'var(--border)'}`,
                  borderRadius: 'var(--radius)',
                  fontSize: '1rem'
                }}
              />
          ...
          <div style={{ marginBottom: 'var(--spacing-md)' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              >
                <Icon 
                  icon={showPassword ? 'fluent:eye-off-24-filled' : 'fluent:eye-24-filled'} 
                  width="20" 
                />
              </button>
            </div>
